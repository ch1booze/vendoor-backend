...
export const resolvers: Resolvers = {
	Query: {
		...
		businessById: Query_businessById,
		businessChats: Query_businessChats,
		businessCustomerById: Query_businessCustomerById,
		businessCustomers: Query_businessCustomers,
		businessOrderById: Query_businessOrderById,
		businessOrders: Query_businessOrders,
		businessProductById: Query_businessProductById,
		businessProducts: Query_businessProducts,
		businessesForCustomer: Query_businessesForCustomer,
		customer: Query_customer,
		customerChatsForBusiness: Query_customerChatsForBusiness,
		customerOrderById: Query_customerOrderById,
		customerOrders: Query_customerOrders,
		customerProductById: Query_customerProductById,
		customerProducts: Query_customerProducts,
		stockEvents: Query_stockEvents,
	},
	Mutation: {
		cancelCustomerOrder: Mutation_cancelCustomerOrder,
		createBusiness: Mutation_createBusiness,
		createBusinessChat: Mutation_createBusinessChat,
		createCustomerChat: Mutation_createCustomerChat,
		createCustomerOrder: Mutation_createCustomerOrder,
		createProduct: Mutation_createProduct,
		createStockEvent: Mutation_createStockEvent,
		deleteProduct: Mutation_deleteProduct,
		registerCustomer: Mutation_registerCustomer,
		updateBusiness: Mutation_updateBusiness,
		updateCustomerOrder: Mutation_updateCustomerOrder,
