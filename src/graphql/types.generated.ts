...
> = {
	businessChats?: Resolver<
		Array<ResolversTypes['BusinessChat']>,
		ParentType,
		ContextType
	>;
	customerChats?: Resolver<
		Array<ResolversTypes['CustomerChat']>,
		ParentType,
		ContextType
	>;
	customers?: Resolver<
...
export type BusinessChatResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['BusinessChat'] = ResolversParentTypes['BusinessChat'],
> = {
...
export type CustomerChatResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['CustomerChat'] = ResolversParentTypes['CustomerChat'],
> = {
	business?: Resolver<ResolversTypes['Business'], ParentType, ContextType>;
	businessId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
	createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type InventoryResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['Inventory'] = ResolversParentTypes['Inventory'],
> = {
	createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
> = {
	cancelCustomerOrder?: Resolver<
		ResolversTypes['Boolean'],
		ParentType,
		ContextType,
		RequireFields<MutationcancelCustomerOrderArgs, 'orderId'>
	>;
	...
	>;
	createBusinessChat?: Resolver<
		ResolversTypes['BusinessChat'],
		ParentType,
		ContextType,
		RequireFields<MutationcreateBusinessChatArgs, 'query'>
	>;
	createCustomerChat?: Resolver<
		ResolversTypes['CustomerChat'],
		ParentType,
		ContextType,
		RequireFields<MutationcreateCustomerChatArgs, 'input'>
	>;
	createCustomerOrder?: Resolver<
		ResolversTypes['Order'],
		ParentType,
		ContextType,
		RequireFields<MutationcreateCustomerOrderArgs, 'input'>
	>;
	createInventory?: Resolver<
		ResolversTypes['Inventory'],
		ParentType,
		ContextType,
		RequireFields<MutationcreateInventoryArgs, 'input'>
	>;
	...
	updateBusiness?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationupdateBusinessArgs, 'input'>
	>;
	updateCustomerOrder?: Resolver<
		ResolversTypes['Order'],
		ParentType,
		ContextType,
		RequireFields<MutationupdateCustomerOrderArgs, 'input'>
	>;
...
> = {
	business?: Resolver<ResolversTypes['Business'], ParentType, ContextType>;
	businessById?: Resolver<
		ResolversTypes['Business'],
		ParentType,
		ContextType,
		RequireFields<QuerybusinessByIdArgs, 'businessId'>
	>;
	businessChats?: Resolver<
		Array<Maybe<ResolversTypes['BusinessChat']>>,
		ParentType,
		ContextType
	>;
	businessCustomerById?: Resolver<
		ResolversTypes['Customer'],
		ParentType,
		ContextType,
		RequireFields<QuerybusinessCustomerByIdArgs, 'customerId'>
	>;
	businessCustomers?: Resolver<
		Array<Maybe<ResolversTypes['Customer']>>,
		ParentType,
		ContextType
	>;
	businessOrderById?: Resolver<
		Maybe<ResolversTypes['Order']>,
		ParentType,
		ContextType,
		RequireFields<QuerybusinessOrderByIdArgs, 'orderId'>
	>;
	businessOrders?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Order']>>>,
		ParentType,
		ContextType
	>;
	businessProductById?: Resolver<
		Maybe<ResolversTypes['Product']>,
		ParentType,
		ContextType,
		RequireFields<QuerybusinessProductByIdArgs, 'id'>
	>;
	businessProducts?: Resolver<
		Array<Maybe<ResolversTypes['Product']>>,
		ParentType,
		ContextType
	>;
	businessesForCustomer?: Resolver<
		Array<Maybe<ResolversTypes['Business']>>,
		ParentType,
		ContextType
	>;
	customer?: Resolver<ResolversTypes['Customer'], ParentType, ContextType>;
	customerChatsForBusiness?: Resolver<
		Array<ResolversTypes['CustomerChat']>,
		ParentType,
		ContextType,
		RequireFields<QuerycustomerChatsForBusinessArgs, 'businessId'>
	>;
	customerOrderById?: Resolver<
		Maybe<ResolversTypes['Order']>,
		ParentType,
		ContextType,
		RequireFields<QuerycustomerOrderByIdArgs, 'orderId'>
	>;
	customerOrders?: Resolver<
		Array<ResolversTypes['Order']>,
		ParentType,
		ContextType,
		RequireFields<QuerycustomerOrdersArgs, 'businessId'>
	>;
	customerProductById?: Resolver<
		Maybe<ResolversTypes['Product']>,
		ParentType,
		ContextType,
		RequireFields<QuerycustomerProductByIdArgs, 'businessId' | 'productId'>
	>;
	customerProducts?: Resolver<
		Array<Maybe<ResolversTypes['Product']>>,
		ParentType,
		ContextType,
		RequireFields<QuerycustomerProductsArgs, 'businessId'>
	>;
	inventories?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Inventory']>>>,
		ParentType,
		ContextType
	>;
};
