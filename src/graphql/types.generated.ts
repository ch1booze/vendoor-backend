...
> = {
	...
	>;
	createStockEvent?: Resolver<
		ResolversTypes['StockEvent'],
		ParentType,
		ContextType,
		RequireFields<MutationcreateStockEventArgs, 'input'>
	>;
...
> = {
	...
	>;
	stockEvents?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['StockEvent']>>>,
		ParentType,
		ContextType
	>;
};
...
export type StockEventResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['StockEvent'] = ResolversParentTypes['StockEvent'],
> = {
	createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
